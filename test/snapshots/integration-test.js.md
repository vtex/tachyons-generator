...
> Snapshot 1
    ...
    */␊
    ...
    body, button, input, optgroup, select, textarea { font-smooth: antialiased; font-family: 'Fabriga', -apple-system, BlinkMacSystemFont, avenir next, avenir, helvetica neue, helvetica, ubuntu, roboto, noto, segoe ui, arial, sans-serif; }␊

...
> Snapshot 1
    ...
    .bg-base--inverted { background-color: #585959; }␊
    .bg-action-primary { background-color: #368df7; }␊
    .bg-action-secondary { background-color: #edf4fa; }␊
    .bg-emphasis { background-color: #f71963; }␊
    .bg-disabled { background-color: #cacbcc; }␊
    ...
    .bg-warning--faded { background-color: #fff7e1; }␊
    .bg-info { background-color: #edf4fa; }␊
    .bg-info--faded { background-color: #edf4fa; }␊
    .bg-muted-1 { background-color: #f2f4f5; }␊
    .bg-muted-2 { background-color: #e3e4e6; }␊
    .bg-muted-3 { background-color: #cacbcc; }␊
    .bg-muted-4 { background-color: #979899; }␊
    .bg-muted-5 { background-color: #727273; }␊
    .bg-transparent { background-color: transparent; }␊
    ...
    .b--action-primary { border-color: #368df7; }␊
    .b--action-secondary { border-color: #edf4fa; }␊
    .b--emphasis { border-color: #f71963; }␊
    .b--disabled { border-color: #cacbcc; }␊
    ...
    .b--warning--faded { border-color: #fff7e1; }␊
    .b--info { border-color: #edf4fa; }␊
    .b--info--faded { border-color: #edf4fa; }␊
    .b--muted-1 { border-color: #f2f4f5; }␊
    .b--muted-2 { border-color: #e3e4e6; }␊
    .b--muted-3 { border-color: #cacbcc; }␊
    .b--muted-4 { border-color: #979899; }␊
    .b--muted-5 { border-color: #727273; }␊
    .b--transparent { border-color: transparent; }␊
    /*␊
    ␊
      BORDER RADIUS␊
    ...
    */␊
    ...
    .c-action-primary { color: #368df7; }␊
    .c-action-secondary { color: #368df7; }␊
    .c-emphasis { color: #f71963; }␊
    .c-disabled { color: #cacbcc; }␊
    .c-success { color: #8bc34a; }␊
    .c-success--faded { color: #eafce3; }␊
    .c-danger { color: #ff4c4c; }␊
    .c-danger--faded { color: #ffe6e6; }␊
    .c-warning { color: #ffb100; }␊
    .c-warning--faded { color: #fff7e1; }␊
    .c-info { color: #edf4fa; }␊
    .c-info--faded { color: #edf4fa; }␊
    .c-muted-1 { color: #979899; }␊
    .c-muted-2 { color: #979899; }␊
    .c-muted-3 { color: #979899; }␊
    .c-muted-4 { color: #979899; }␊
    .c-muted-5 { color: #979899; }␊
    .c-on-base { color: #3f3f40; }␊
    .c-on-base--inverted { color: #fff; }␊
    .c-on-action-primary { color: #fff; }␊
    .c-on-action-secondary { color: #368df7; }␊
    .c-on-emphasis { color: #fff; }␊
    .c-on-disabled { color: #cacbcc; }␊
    ...
    .c-on-info { color: #3f3f40; }␊
    .c-on-info--faded { color: #3f3f40; }␊
    .c-on-muted-1 { color: #979899; }␊
    .c-on-muted-2 { color: #979899; }␊
    .c-on-muted-3 { color: #979899; }␊
    .c-on-muted-4 { color: #979899; }␊
    .c-on-muted-5 { color: #979899; }␊
    ...
    .hover-c-action-primary:focus { color: #368df7; }␊
    .hover-c-action-primary:hover { color: #368df7; }␊
    .hover-c-action-secondary:focus { color: #2a6dbf; }␊
    .hover-c-action-secondary:hover { color: #2a6dbf; }␊
    .hover-c-emphasis:focus { color: #f71963; }␊
    .hover-c-emphasis:hover { color: #f71963; }␊
    ...
    .hover-c-warning--faded:focus { color: #fff7e1; }␊
    .hover-c-warning--faded:hover { color: #fff7e1; }␊
    .hover-c-info:focus { color: #edf4fa; }␊
    .hover-c-info:hover { color: #edf4fa; }␊
    .hover-c-info--faded:focus { color: #edf4fa; }␊
    .hover-c-info--faded:hover { color: #edf4fa; }␊
    .hover-c-muted-1:focus { color: #979899; }␊
    .hover-c-muted-1:hover { color: #979899; }␊
    .hover-c-muted-2:focus { color: #979899; }␊
    .hover-c-muted-2:hover { color: #979899; }␊
    .hover-c-muted-3:focus { color: #979899; }␊
    .hover-c-muted-3:hover { color: #979899; }␊
    .hover-c-muted-4:focus { color: #979899; }␊
    .hover-c-muted-4:hover { color: #979899; }␊
    .hover-c-muted-5:focus { color: #979899; }␊
    .hover-c-muted-5:hover { color: #979899; }␊
    .hover-c-on-action-primary:focus { color: #fff; }␊
    .hover-c-on-action-primary:hover { color: #fff; }␊
    .hover-c-on-action-secondary:focus { color: #2a6dbf; }␊
    .hover-c-on-action-secondary:hover { color: #2a6dbf; }␊
    ...
    .hover-c-on-info:focus { color: #3f3f40; }␊
    .hover-c-on-info:hover { color: #3f3f40; }␊
    .hover-c-on-info--faded:focus { color: #3f3f40; }␊
    .hover-c-on-info--faded:hover { color: #3f3f40; }␊
    .hover-c-on-muted-1:focus { color: #979899; }␊
    .hover-c-on-muted-1:hover { color: #979899; }␊
    .hover-c-on-muted-2:focus { color: #979899; }␊
    .hover-c-on-muted-2:hover { color: #979899; }␊
    .hover-c-on-muted-3:focus { color: #979899; }␊
    .hover-c-on-muted-3:hover { color: #979899; }␊
    .hover-c-on-muted-4:focus { color: #979899; }␊
    .hover-c-on-muted-4:hover { color: #979899; }␊
    .hover-c-on-muted-5:focus { color: #979899; }␊
    .hover-c-on-muted-5:hover { color: #979899; }␊
    .hover-bg-action-primary:focus { background-color: #2a6dbf; }␊
    .hover-bg-action-primary:hover { background-color: #2a6dbf; }␊
    .hover-bg-action-secondary:focus { background-color: #edf4fa; }␊
    .hover-bg-action-secondary:hover { background-color: #edf4fa; }␊
    .hover-bg-emphasis:focus { background-color: #f71963; }␊
    .hover-bg-emphasis:hover { background-color: #f71963; }␊
    ...
    .hover-bg-danger:focus { background-color: #ff4c4c; }␊
    .hover-bg-danger:hover { background-color: #ff4c4c; }␊
    ...
    .hover-bg-warning--faded:focus { background-color: #fff7e1; }␊
    .hover-bg-warning--faded:hover { background-color: #fff7e1; }␊
    .hover-bg-info:focus { background-color: #edf4fa; }␊
    .hover-bg-info:hover { background-color: #edf4fa; }␊
    .hover-bg-info--faded:focus { background-color: #edf4fa; }␊
    .hover-bg-info--faded:hover { background-color: #edf4fa; }␊
    .hover-bg-muted-1:focus { background-color: #f2f4f5; }␊
    .hover-bg-muted-1:hover { background-color: #f2f4f5; }␊
    .hover-bg-muted-2:focus { background-color: #e3e4e6; }␊
    .hover-bg-muted-2:hover { background-color: #e3e4e6; }␊
    .hover-bg-muted-3:focus { background-color: #cacbcc; }␊
    .hover-bg-muted-3:hover { background-color: #cacbcc; }␊
    .hover-bg-muted-4:focus { background-color: #979899; }␊
    .hover-bg-muted-4:hover { background-color: #979899; }␊
    .hover-bg-muted-5:focus { background-color: #727273; }␊
    .hover-bg-muted-5:hover { background-color: #727273; }␊
    .hover-b--action-primary:focus { border-color: #2a6dbf; }␊
    .hover-b--action-primary:hover { border-color: #2a6dbf; }␊
    .hover-b--action-secondary:focus { border-color: #edf4fa; }␊
    .hover-b--action-secondary:hover { border-color: #edf4fa; }␊
    .hover-b--emphasis:focus { border-color: #f71963; }␊
    .hover-b--emphasis:hover { border-color: #f71963; }␊
    ...
    .hover-b--danger:focus { border-color: #ff4c4c; }␊
    .hover-b--danger:hover { border-color: #ff4c4c; }␊
    ...
    .hover-b--warning--faded:focus { border-color: #fff7e1; }␊
    .hover-b--warning--faded:hover { border-color: #fff7e1; }␊
    .hover-b--info:focus { border-color: #edf4fa; }␊
    .hover-b--info:hover { border-color: #edf4fa; }␊
    .hover-b--info--faded:focus { border-color: #edf4fa; }␊
    .hover-b--info--faded:hover { border-color: #edf4fa; }␊
    .hover-b--muted-1:focus { border-color: #f2f4f5; }␊
    .hover-b--muted-1:hover { border-color: #f2f4f5; }␊
    .hover-b--muted-2:focus { border-color: #e3e4e6; }␊
    .hover-b--muted-2:hover { border-color: #e3e4e6; }␊
    .hover-b--muted-3:focus { border-color: #cacbcc; }␊
    .hover-b--muted-3:hover { border-color: #cacbcc; }␊
    .hover-b--muted-4:focus { border-color: #979899; }␊
    .hover-b--muted-4:hover { border-color: #979899; }␊
    .hover-b--muted-5:focus { border-color: #727273; }␊
    .hover-b--muted-5:hover { border-color: #727273; }␊
